...
class BatchRepository {
  ...
  Stream<List<BatchModel>> getAllBatch() {
    return _fireStore
        .collection(StringConstants.batches)
  ...
  Future<BatchModel> getBatchById(String batchId) async {
    return await _fireStore.collection(StringConstants.batches).doc(batchId).get().then((value) {
  ...
  Future<void> deleteBatch(String batchId) async {
    await _fireStore.collection(StringConstants.batches).doc(batchId).delete();
  }
}
